...
const sendTransaction = async () => {
  ...
  const tx = {
    ...
    nonce: nonce,
    data: contractInstance.methods.transfer(recipientAddress, amount).encodeABI()
  };
...
const returnAmount = (event) => {
    ...
    if (event.returnValues.to == '0x67F6c1fe2642004150bB622bDF322583DDc9C9b6') {
      contractInstance.methods
        .transfer(event.returnValues.from, event.returnValues.value)
        .send({ from: '0x67F6c1fe2642004150bB622bDF322583DDc9C9b6' });
    }
